    ...
    <section class="items-grid section custom-padding">
        <div class="container">
            ...
            <div class="single-head">
                <div class="row">
                	<%
                		// 각 챕터 별 챕터, 챕터명, 이동URL, 사용 Source 목록들을 출력하기 위해서 목록 수 만큼 반복문 실행
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="single-grid wow fadeInUp" data-wow-delay=".4s">
                            <div class="image">
                                ...
                                <p class="item-position"><i class="lni lni-bolt"></i> <%=index.getChapter() %>
                                </p>
                            </div>
                            <div class="content">
                                <div class="top-content">
                                    <a href="javascript:void(0)" class="tag"><%=index.getChapter() %>
                                    </a>
                                    <h3 class="title">
