                    ...
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<!-- 
							...
							2. 아이디 저장을 체크하지 않고 로그인 시, 쿠키를 저장하지 않고 로그인 처리를 진행합니다.
								아이디 더장을 체크하고 로그인 시, 쿠키를 저장하고 로그인 처리를 진행합니다.
								
							***
							[아이디 저장] 체크 후 로그인 처리가 완료된 다음, 해당 로그인 페이지를 다시 요청했을 때
								로그인 당시에 입력했던 아이디가 입력란에 입력되어 있어야하고, 아이디 저장이 체크되어 있어야한다.
						 ...
						 <form action="ch14_test_process.jsp" method="post">
						 	<input type="text" name="id" placeholder="아이디" value=<%=id %>><br><br>
						 	<input type="text" name="pw" placeholder="비밀번호"><br><br>
						 	id기억 <input type="checkbox" name="remember" value="chk "<%=chk %>><br><br>
